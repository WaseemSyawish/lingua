...
export default function SignInPage() {
  ...
  const handleGoogleSignIn = () => {
    ...
    // Note: for OAuth, signIn redirects the page so setGoogleLoading(false) is never reached on success.
    // On failure NextAuth redirects back here with ?error=... which the useEffect above handles.
  };
            ...
            <CardContent className="pt-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="identifier" className="text-sm font-medium">Email or User ID</Label>
                  <Input
                    id="identifier"
                    type="text"
                    value={identifier}
                    onChange={(e) => setIdentifier(e.target.value)}
                    placeholder="you@example.com or cmm..."
